...
export function Hero(){
    ...
    return(
        ...
        <section className = "bg-[#ffadbb] text-white relative overflow-hidden">
            ...
            <div className = "container mx-auto pt-16 pb-16 md:pb-0 py-4 px-4 relative">
                ...
                <article className = "grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className = "space-y-6">
                        ...
                        <p className = "lg:text-lg">
                            Ofereçemos os melhores vestidos e pijamas para garantir seu estilo e conforto em qualquer ocasião. 
                        </p>

                            <a href = "https://wa.me/5561999785395" target = "_blank" className = "bg-green-500 px-5 py-2 rounded-md font-semibold flex items-center justify-center w-fit gap-2 mb-8">
